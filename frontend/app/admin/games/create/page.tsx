...
export default function CreateGamePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // POST je PROTECTED — koristi apiFetch
    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col gap-6">
        <div>
          ...
          <input name="title" value={form.title} onChange={handleChange} placeholder="Game title"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="releaseYear" value={form.releaseYear} onChange={handleChange} placeholder="2024"
              className="w-full border border-gray-300 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500" />
          </div>
        </div>
  ...
  {form.coverImage && (
    ...
    />
        ...
        <div>
          ...
          <textarea name="description" value={form.description} onChange={handleChange} rows={4} placeholder="Game description..."
            className="w-full border border-gray-300 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500" />
        </div>
        ...
        <button onClick={handleSubmit} disabled={loading || uploading || !isFormValid}
